...
export interface SpotifyDraggableProps {
...
const SpotifyDraggable = ({ discordId, demoTrack, dragThreshold = 25 }: SpotifyDraggableProps) => {
...
export default SpotifyDraggable;
